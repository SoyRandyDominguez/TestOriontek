...
{
    public class TaskRepository : TestOriontecRepositoryBase<Task, long>, ITaskRepository
    {
        public TaskRepository(IDbContextProvider<TestOriontecDbContext> dbContextProvider)
